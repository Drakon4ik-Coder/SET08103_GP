...
public class Query {
    ...
    public static class City {
        ...
        public static String getWorldDesc(){ return WORLD_DESC; }
        public static String getContinentDesc(String continent){ return String.format(CONTINENT_DESC, continent);}
